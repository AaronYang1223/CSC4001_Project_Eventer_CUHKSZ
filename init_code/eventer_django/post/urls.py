...
urlpatterns = [
    ...
    path('post/user/order/comment_number/<int:user_id>', views.post_user_order_comment_num),
    path('post/user/order/create_date/<int:user_id>', views.post_user_order_create_date),
